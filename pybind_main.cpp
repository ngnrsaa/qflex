...
std::vector<std::pair<std::string, std::complex<double>>> simulate(std::vector<std::string> circuit_content,
...
//   }
    ...
    for(std::vector<std::string>::size_type i = 0; i < circuit_content.size(); i++)
    {
...
//   }
    ...
    for(std::vector<std::string>::size_type i = 0; i < ordering_content.size(); i++)
    {
...
//   }
    ...
    for(std::vector<std::string>::size_type i = 0; i < grid_content.size(); i++)
    {
