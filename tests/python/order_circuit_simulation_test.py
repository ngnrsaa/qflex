...
def test_circuit_to_ordering():
  ...
  """
    ...
    assert order2_30 == [
        # 1: ['SWAP((3, 2), (3, 3))', 'SWAP((3, 2), (3, 3))', 'CZ((3, 2), (3, 3))']
        "expand A 14",
        "expand A 15",
        # 2: ['SWAP((0, 0), (1, 0))', 'SWAP((0, 0), (1, 0))', 'CZ((0, 0), (1, 0))']
        "expand B 0",
        "expand B 4",
        # 3: ['SWAP((0, 2), (0, 3))', 'SWAP((0, 2), (0, 3))', 'CZ((0, 2), (0, 3))']
        "expand C 2",
        "expand C 3",
        # 4: ['SWAP((2, 3), (3, 3))', 'SWAP((2, 3), (3, 3))']
        "expand A 11",
        # 5: ['SWAP((2, 2), (2, 3))', 'SWAP((2, 2), (2, 3))', 'SWAP((2, 2), (3, 2))', 'CZ((2, 2), (3, 2))']
        "expand A 10",
        # 6: ['SWAP((1, 3), (2, 3))', 'SWAP((1, 3), (2, 3))', 'CZ((1, 3), (2, 3))']
        "expand A 7",
        # 7: ['SWAP((1, 2), (2, 2))', 'SWAP((1, 2), (2, 2))', 'SWAP((1, 2), (1, 3))']
        "expand A 6",
        # 8: ['SWAP((0, 2), (1, 2))', 'SWAP((0, 3), (1, 3))', 'SWAP((0, 3), (1, 3))']
        "merge A C",
        # 9: ['SWAP((0, 1), (0, 2))', 'SWAP((0, 1), (0, 2))']
        "expand C 1",
        # 10: ['SWAP((0, 1), (1, 1))', 'SWAP((0, 1), (1, 1))', 'CZ((0, 1), (1, 1))', 'SWAP((1, 1), (1, 2))']
        "expand C 5",
        # 11: ['SWAP((2, 0), (3, 0))', 'SWAP((2, 0), (3, 0))']
        "expand D 8",
        "expand D 12",
        # 12: ['SWAP((0, 0), (0, 1))', 'CZ((0, 0), (0, 1))', 'SWAP((1, 0), (1, 1))']
        "merge B C"
    ]
    # The order of these two operations doesn't matter.
    # 13: ['SWAP((1, 0), (2, 0))', 'SWAP((1, 0), (2, 0))', 'CZ((1, 0), (2, 0))']
    # 14: ['SWAP((1, 1), (2, 1))', 'SWAP((1, 1), (2, 1))', 'CZ((1, 1), (2, 1))', 'SWAP((2, 0), (2, 1))', 'SWAP((2, 0), (2, 1))']
    assert (["expand C 9", "merge C D"] == [order[31], order[33]] or
            ["merge C D", "expand D 9"] == [order[31], order[33]])
    # 15: ['SWAP((2, 1), (3, 1))', 'CZ((2, 1), (3, 1))', 'SWAP((3, 0), (3, 1))', 'CZ((3, 0), (3, 1))']
