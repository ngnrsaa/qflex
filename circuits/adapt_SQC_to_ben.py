...
for line in lines[1:]:
  ...
  if len(l)==3:
    if int(l[2]) in sites_map:
      ...
      print(str_print)
  if len(l)==4:
    if (int(l[2]) in sites_map) and (int(l[3]) in sites_map):
      str_print += l[0]
      str_print += ' '
      str_print += l[1]
      str_print += ' '
      ...
      print(str_print)
  if len(l)==5:
    if (int(l[3]) in sites_map) and (int(l[4]) in sites_map):
      str_print += l[0]
      str_print += ' '
      str_print += l[1]
      str_print += ' '
      ...
      str_print += str(sites_map[int(l[3])])
      str_print += ' '
      str_print += str(sites_map[int(l[4])])
      print(str_print)
