...
int main(int argc, char **argv) {
  ...
  std::vector<std::vector<int>> qubits_off({
    ...
    {7,0},{7,1},{7,2},{7,3}                        ,{7,8},{7,9},{7,10},{7,11},
    {8,0},{8,1},{8,2},{8,3},{8,4}            ,{8,7},{8,8},{8,9},{8,10},{8,11},
  ...
  */
  ...
  MKLTensor t42({""}, {(int)pow(super_dim,2)});
  MKLTensor t33({""}, {(int)pow(super_dim,3)});
  ...
  MKLTensor c49({""}, {(int)pow(super_dim,3)});
  MKLTensor c58({""}, {(int)pow(super_dim,4)});
  MKLTensor c59({""}, {(int)pow(super_dim,2)});
  MKLTensor c68({""}, {(int)pow(super_dim,2)});
  t1 = high_resolution_clock::now();
  time_span = duration_cast<duration<double>>(t1 - t0);
  ...
  */
  ...
  for (int cut=0; cut<cut_combinations_taken.size(); ++cut)
  {
    ...
    tensor_grid[3][3].project("(3,3),(4,3)", i1, t33);
    tensor_grid[4][3].project("(3,3),(4,3)", i1, t43);
    // Build A.
    multiply(t42, tensor_grid[5][2], H_2_legs_a, scratch);
    multiply(H_2_legs_a, t43, H_3_legs_a, scratch);
    multiply(H_3_legs_a, tensor_grid[5][3], H_3_legs_b, scratch);
    multiply(H_3_legs_b, tensor_grid[6][3], H_3_legs_a, scratch);
    multiply(H_3_legs_a, tensor_grid[4][4], H_5_legs_a, scratch);
    multiply(H_5_legs_a, tensor_grid[5][4], H_5_legs_b, scratch);
    multiply(H_5_legs_b, tensor_grid[6][4], H_5_legs_a, scratch);
    multiply(H_5_legs_a, tensor_grid[7][4], H_5_legs_b, scratch);
    multiply(H_5_legs_b, tensor_grid[4][5], H_7_legs_a, scratch);
    multiply(H_7_legs_a, tensor_grid[5][5], H_7_legs_b, scratch);
    ...
    multiply(H_2_legs_a, tensor_grid[2][3], H_2_legs_b, scratch);
    multiply(H_2_legs_b, tensor_grid[3][4], H_4_legs_a, scratch);
    multiply(H_4_legs_a, tensor_grid[2][4], H_4_legs_b, scratch);
    multiply(H_4_legs_b, tensor_grid[1][4], H_4_legs_a, scratch);
    multiply(H_4_legs_a, tensor_grid[3][5], H_6_legs_a, scratch);
    multiply(H_6_legs_a, tensor_grid[2][5], H_6_legs_b, scratch);
    multiply(H_6_legs_b, tensor_grid[1][5], H_6_legs_a, scratch);
    multiply(H_6_legs_a, tensor_grid[0][5], H_6_legs_b, scratch);
    multiply(H_6_legs_b, tensor_grid[0][6], H_6_legs_a, scratch);
    multiply(H_6_legs_a, tensor_grid[1][6], H_6_legs_b, scratch);
    multiply(H_6_legs_b, tensor_grid[2][6], H_6_legs_a, scratch);
    multiply(H_6_legs_a, tensor_grid[3][6], H_6_legs_b, scratch);
    ...
    for (int c=0; c<num_Cs; ++c)
    {
      ...
      tensor_grid[3][9].project("(3,9),(o)", (string_A[2]=='0')?0:1, c39);
      tensor_grid[4][8].project("(4,8),(o)", (string_A[3]=='0')?0:1, c48);
      tensor_grid[4][9].project("(4,9),(o)", (string_A[4]=='0')?0:1, c49);
      ...
      multiply(H_5_legs_a, c28, H_5_legs_b, scratch);
      multiply(H_5_legs_b, c48, H_5_legs_a, scratch);
      multiply(H_5_legs_a, c58, H_5_legs_b, scratch);
      multiply(H_5_legs_b, c68, C, scratch);
      t1 = high_resolution_clock::now();
      time_span = duration_cast<duration<double>>(t1 - t0);
