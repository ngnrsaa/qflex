...
Contraction::Contraction(string input_string, int _num_args, int _num_amps)
{
  ...
  S05 = shared_ptr<talsh::Tensor>(new talsh::Tensor(dims_1, s_type(0.0)));
  S06 = shared_ptr<talsh::Tensor>(new talsh::Tensor(dims_1, s_type(0.0)));
  S15 = shared_ptr<talsh::Tensor>(new talsh::Tensor(dims_3, s_type(0.0)));
  S16 = shared_ptr<talsh::Tensor>(new talsh::Tensor(dims_3, s_type(0.0)));
  S25 = shared_ptr<talsh::Tensor>(new talsh::Tensor(dims_3, s_type(0.0)));
  S26 = shared_ptr<talsh::Tensor>(new talsh::Tensor(dims_3, s_type(0.0)));
...
void Contraction::contract(string input_string)
{
  ...
  conts_gpu.emplace_back(
    TensContraction("D(a,b,c,d,f,g)+=L(a,b,c,d,e)*R(e,f,g)",
    H_6_legs_a.get(), H_5_legs_a.get(), tensor_grid[3][3].get()));
  conts_gpu.emplace_back(
    TensContraction("D(a,b,c,g,h,f)+=L(a,b,c,d,e,f)*R(e,d,g,h)",
    H_6_legs_b.get(), H_6_legs_a.get(), tensor_grid[4][3].get()));
  conts_gpu.emplace_back(
    TensContraction("D(a,b,g,h,e,f)+=L(a,b,c,d,e,f)*R(d,c,g,h)",
    H_6_legs_a.get(), H_6_legs_b.get(), tensor_grid[5][3].get()));
  conts_gpu.emplace_back(
    TensContraction("D(a,g,h,d,e,f)+=L(a,b,c,d,e,f)*R(c,b,g,h)",
    H_6_legs_b.get(), H_6_legs_a.get(), tensor_grid[6][3].get()));
  conts_gpu.emplace_back(
    TensContraction("D(g,h,c,d,e,f)+=L(a,b,c,d,e,f)*R(b,a,g,h)",
    H_6_legs_a.get(), H_6_legs_b.get(), tensor_grid[7][3].get()));
  conts_gpu.emplace_back(
    TensContraction("D(g,b,c,d,e,f)+=L(a,b,c,d,e,f)*R(a,g)",
  ...
  // Corner (starting with 36) (only last one, because of sync on DEV_NVIDIA_GPU)
  ...
  t1 = high_resolution_clock::now();
  span = duration_cast<duration<double>>(t1 - t0);
  cout << "Time spent building B is " << span.count() << endl;
